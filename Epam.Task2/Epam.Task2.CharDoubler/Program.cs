...
namespace Epam.Task2.CharDoubler
{
    class Program
    {
        static void Main()
        {
            Console.WriteLine("Greatings! You are using The Char "
                             + "Doubler Program!");
            Console.WriteLine();
            ...
            Console.WriteLine("Please, enter the additional string "
                              + $"which characters will double{Environment.NewLine}"
                              + "same characters in the main string:");
        ...
        private static string CharDoubler(string mainString,
