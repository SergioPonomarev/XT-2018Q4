...
namespace Epam.Task8.DateExistance
{
    ...
    {
        private const string DatePattern = @"((?:0[1-9]|[12][0-9]|3[01])-(?:0[13578]|1[02])-(?:[0-9]{4}))|((?:0[1-9]|[12][0-9]|30)-(?:0[469]|11)-(?:[0-9]{4}))|((?:0[1-9]|1[0-9]|2[0-8])-02-(?:[0-9]{4}))|(29-02-[0-9][0-9]([02468][048]|[13579][26]))";
